...
<body class="flex flex-col min-h-screen">
    ...
    <div class="flex flex-col min-h-screen overlay">
        ...
        <main class="flex-grow">
            ...
            <!-- Hero Section -->
            <section class="relative flex justify-end items-start py-32 text-left">
                ...
                <a href="/loginPage"
                    class="top-0 right-0 absolute bg-transparent opacity-50 hover:opacity-100 px-2 py-1 rounded text-white text-sm">
                    Browse eBooks
                </a>
            </section>
            ...
            <!-- CTA Section -->
            <section id="cta-section" class="bg-white/90 backdrop-blur-sm py-10 w-full text-[#514d4d]">
                ...
                <div class="mx-auto px-4 max-w-6xl">
                    ...
                    <div class="gap-8 grid md:grid-cols-3">
                        ...
                        <?= view('components/cards/product_cards', [
                            ...
                            "price" => 149,
                            "image" => "https://unsw-prod.s3.amazonaws.com/media/S/compressed.photo.goodreads.com/books/1538457160i/41188320.jpg"
                        ]) ?>
                        <?= view('components/cards/product_cards', [
